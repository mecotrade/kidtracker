...
const i18n = {
    ...
    tokens: {
        ru: {
            ...
            'Upload interval': 'Интервал обновления',
            'Upload interval should not be less than {}': 'Интервал обновления не должен быть меньше чем {}',
            'Watch Time': 'Время часов',
            'Send text message when SOS button pressed': 'Отправлять SMS если нажата кнопка SOS',
