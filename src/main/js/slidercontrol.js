...
L.Control.SliderControl = L.Control.extend({
    ...
    onAdd: function (map) {
        ...
        $(sliderContainer).append('<div id="leaflet-slider" style="width:200px;margin-top:27px"><div class="ui-slider-handle"></div><div id="slider-timestamp" style="width:200px;margin-top:-25px; background-color:#FFFFFF; text-align:center; border-radius:5px;"></div></div>');
